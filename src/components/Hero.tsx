...
// import img1 from '../../public/image/slider/2.1.jpg';
    ...
    <section id="home" className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-20 container mx-auto px-6 pt-32 pb-20">
        <div className="max-w-4xl mx-auto text-center">
          <motion.h1
            className="font-montserrat font-bold text-6xl md:text-8xl lg:text-9xl mb-8 
          ...
          {/* Subtitle */}
          <motion.p
            className="font-poppins text-2xl md:text-4xl font-semibold mb-6 
                 bg-gradient-to-r from-[#FFD700] via-[#e75480] to-[#50c878] 
                 bg-clip-text text-transparent tracking-tight drop-shadow-sm"
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8, delay: 0.5 }}
          >
            Crafting Luxury, Celebrating Moments
          </motion.p>

          {/* Description */}
          <motion.p
            className="font-poppins text-base md:text-lg text-[#f0f0f0] max-w-3xl mx-auto 
                 mb-12 leading-relaxed text-center"
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8, delay: 0.7 }}
          >
            Since <span className="text-[#FFD700] font-semibold">12.12.12</span>
            , we’ve brought to life world-class experiences through elite event
            management, immersive AV production, and creative storytelling —
