...
// import img1 from '../../public/image/aboutus/event.jpg';
...
const About = () => {
  return (
    ...
    >
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          {/* Left side - Clean Professional Image Layout */}
          <motion.div
            className="relative"
            initial={{ opacity: 0, x: -50 }}
            whileInView={{ opacity: 1, x: 0 }}
          ...
          >
            <div className="relative max-w-lg mx-auto">
              ...
              {/* Two smaller images in a clean grid below */}
              <div className="grid grid-cols-2 gap-4 mt-6">
                <img
                  src={img2}
                  alt="Wedding event ambiance"
              ...
              {/* Simple badge */}
              <div className="absolute -top-4 -right-4 bg-gradient-to-r from-luxury-gold to-luxury-rose text-white px-4 py-2 rounded-lg font-semibold shadow-lg text-sm">
                Since 12-12-12
              </div>
            </div>
          </motion.div>
